...
# 1. Properly define helper functions once
helpers = """
...
# Remove duplicated helpers if any
pattern_helpers = r'typedef struct TypeSym TypeSym;.*?default: return \"vlong\";\n\s+\}\n\}'
content = re.sub(pattern_helpers, "", content, flags=re.DOTALL)

# Insert helpers correctly
content = content.replace("char*\nget_sym_type(Node *c, char *name)", helpers + "\nchar*\nget_sym_type(Node *c, char *name)")

# 2. Fix typecheck functions
typecheck_logic = """
Node *cur_meth;
