...
# I will use EXACT string matching and replacement with NO variable interpolation in the replacement strings.
...
content = content.replace(old_map_type, new_map_type)

# is_primitive replacement
old_is_primitive = """int
is_primitive(char *t)
{
    if(t == nil) return 1;
...
content = content.replace(old_is_primitive, new_is_primitive)
