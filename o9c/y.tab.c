...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TCLASS = 5,                     /* TCLASS  */
  YYSYMBOL_TFUNC = 6,                      /* TFUNC  */
  YYSYMBOL_TNEW = 7,                       /* TNEW  */
  YYSYMBOL_TRETURN = 8,                    /* TRETURN  */
  YYSYMBOL_TCHAN = 9,                      /* TCHAN  */
  YYSYMBOL_TEQ = 10,                       /* TEQ  */
  YYSYMBOL_TADD = 11,                      /* TADD  */
  YYSYMBOL_TSUB = 12,                      /* TSUB  */
  YYSYMBOL_TCHANSEND = 13,                 /* TCHANSEND  */
  YYSYMBOL_TCHANRECV = 14,                 /* TCHANRECV  */
  YYSYMBOL_15_ = 15,                       /* '{'  */
  YYSYMBOL_16_ = 16,                       /* '}'  */
  YYSYMBOL_17_ = 17,                       /* ';'  */
  YYSYMBOL_18_ = 18,                       /* '('  */
  ...
  YYSYMBOL_top_levels = 23,                /* top_levels  */
  YYSYMBOL_top_level = 24,                 /* top_level  */
  YYSYMBOL_class_decl = 25,                /* class_decl  */
  YYSYMBOL_member_list = 26,               /* member_list  */
  YYSYMBOL_member = 27,                    /* member  */
  YYSYMBOL_inherit_decl = 28,              /* inherit_decl  */
  YYSYMBOL_var_decl = 29,                  /* var_decl  */
  YYSYMBOL_func_decl = 30,                 /* func_decl  */
...
{
       0,    80,    80,    81,    85,    86,    98,   102,   109,   110,
     126,   127,   128,   132,   139,   147,   155,   156,   172,   173,
     177,   178,   179,   180
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TCLASS", "TFUNC", "TNEW", "TRETURN", "TCHAN", "TEQ", "TADD", "TSUB",
  "TCHANSEND", "TCHANRECV", "'{'", "'}'", "';'", "'('", "'*'", "')'",
  "$accept", "program", "top_levels", "top_level", "class_decl",
  "member_list", "member", "inherit_decl", "var_decl", "func_decl",
  "stmt_list", "stmt", "expr", YY_NULLPTR
};
...
{
       1,     6,    10,     1,    -7,    -7,    -4,    -7,    -7,    -7,
      -1,    -3,    -5,    -7,    -7,    -7,    -7,    -7,     2,    -7,
      14,    -7,     3,    15,     4,    17,     5,     7,    18,    11,
      -7,     0,    -6,    22,    -7,    -7,    12,    -2,    25,    13,
      -7,    -7,    28,    -7,    -7,    -7
};
...
{
       2,     0,     0,     3,     4,     6,     0,     1,     5,     8,
       0,     0,     0,     7,     9,    12,    10,    11,     0,    13,
       0,    14,     0,     0,     0,     0,     0,     0,     0,     0,
      16,     0,    23,     0,    15,    17,     0,     0,     0,     0,
      18,    22,     0,    20,    19,    21
};
...
{
      18,    41,    11,    32,    37,    12,     1,    38,    33,     6,
       7,     9,    42,    20,    19,    13,    34,    22,    24,    21,
      26,    29,    23,    27,    25,    32,    30,    28,    43,    40,
...
{
       3,     3,     3,     3,    10,     6,     5,    13,     8,     3,
       0,    15,    14,    18,    17,    16,    16,     3,     3,    17,
       3,     3,    19,    18,    20,     3,    15,    20,     3,    17,
...
{
       0,     5,    22,    23,    24,    25,     3,     0,    24,    15,
      26,     3,     6,    16,    27,    28,    29,    30,     3,    17,
      18,    17,     3,    19,     3,    20,     3,    18,    20,     3,
      15,    31,     3,     8,    16,    32,    33,    10,    13,    33,
      17,     3,    14,     3,    17,     3
};
...
{
       0,    21,    22,    22,    23,    23,    24,    25,    26,    26,
      27,    27,    27,    28,    29,    30,    31,    31,    32,    32,
      33,    33,    33,    33
};
...
#line 1253 "y.tab.c"
  ...
  case 3: /* program: top_levels  */
#line 81 "o9_plan9.y"
                     { ast_root = (yyvsp[0].node); }
#line 1259 "y.tab.c"
    break;

  case 4: /* top_levels: top_level  */
#line 85 "o9_plan9.y"
                  { (yyval.node) = (yyvsp[0].node); }
#line 1265 "y.tab.c"
    break;

  case 5: /* top_levels: top_levels top_level  */
#line 86 "o9_plan9.y"
                               {
		Node *n;
...
#line 1279 "y.tab.c"
  ...
  case 7: /* class_decl: TCLASS TIDENT '{' member_list '}'  */
#line 103 "o9_plan9.y"
        {
...
#line 1287 "y.tab.c"
  ...
  case 8: /* member_list: %empty  */
#line 109 "o9_plan9.y"
                    { (yyval.node) = nil; }
#line 1293 "y.tab.c"
    break;

  case 9: /* member_list: member_list member  */
#line 110 "o9_plan9.y"
                             {
		Node *n;
...
#line 1319 "y.tab.c"
  ...
  case 14: /* var_decl: TIDENT TIDENT ';'  */
#line 140 "o9_plan9.y"
        {
...
#line 1328 "y.tab.c"
  ...
  case 15: /* func_decl: TFUNC '(' TIDENT '*' TIDENT ')' TIDENT '(' ')' TIDENT '{' stmt_list '}'  */
#line 148 "o9_plan9.y"
        {
		/* func(<Class> *<self>) <name>() <rettype> { ... } */
		(yyval.node) = mk(NMethod, (yyvsp[-6].node)->name, (yyvsp[-3].node)->name, (yyvsp[-1].node), nil);
	}
#line 1337 "y.tab.c"
    break;
...
#line 1367 "y.tab.c"
  ...
  case 19: /* stmt: TRETURN expr ';'  */
#line 173 "o9_plan9.y"
                           { (yyval.node) = mk(NReturn, nil, nil, (yyvsp[-1].node), nil); }
#line 1373 "y.tab.c"
    break;

  case 20: /* expr: TIDENT TCHANSEND TIDENT  */
#line 177 "o9_plan9.y"
                                { (yyval.node) = mk(NChanSend, (yyvsp[-2].node)->name, nil, (yyvsp[0].node), nil); }
#line 1379 "y.tab.c"
    break;

  case 21: /* expr: TIDENT TEQ TCHANRECV TIDENT  */
#line 178 "o9_plan9.y"
                                      { (yyval.node) = mk(NChanRecv, (yyvsp[-3].node)->name, nil, (yyvsp[0].node), nil); }
#line 1385 "y.tab.c"
    break;

  case 22: /* expr: TIDENT TEQ TIDENT  */
#line 179 "o9_plan9.y"
                            { (yyval.node) = mk(NAssign, (yyvsp[-2].node)->name, nil, (yyvsp[0].node), nil); }
#line 1391 "y.tab.c"
    break;
