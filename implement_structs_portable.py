...
# This script re-applies struct support AND makes the output portable.
...
# 2. Type System (map_type, is_primitive, type_cast)
# Map type
new_map_type = """char*
map_type(char *t)
{
...
# 5. Emitted Portability (ainc, adec, File name)
...
content = content.replace("r->fid->file->dir.name", r'#ifdef __GNUC__\n\tr->fid->file->dir.name\n#else\n\tr->fid->file->name\n#endif\n')
